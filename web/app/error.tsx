  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100">
      <div className="bg-white p-8 rounded-lg shadow-md max-w-md w-full">
        ...
        <h2 className="mb-4 text-xl font-semibold text-center text-gray-800">Bir Sorun Oluştu</h2>
        <div className="mb-4 p-3 bg-red-50 rounded-md text-sm font-mono text-red-800 overflow-auto max-h-40">
          {error.message || 'Beklenmeyen bir hata oluştu'}
        </div>
        <p className="mb-6 text-center text-gray-600">
          API sunucusuna bağlanılamıyor olabilir. Sunucunun çalıştığından emin olun.
        </p>
