...
export default function ValidatorForm({ onSubmit, onCancel, loading }: ValidatorFormProps) {
  ...
  return (
    <div className="bg-white border border-gray-200 rounded-lg p-6">
      <div className="mb-6">
        <h3 className="text-lg font-medium text-gray-900 mb-2">Validator Olarak Kaydol</h3>
        <p className="text-sm text-gray-500">
          Validator olmak, blokzincire yeni bloklar ekleyerek işlemleri onaylama yetkisi kazandırır.
          Bunun için insan olduğunuzu kanıtlamanız gerekmektedir.
        </p>
      </div>
        ...
        <div>
          ...
          <div className="mt-1">
            <textarea
              ...
              placeholder="Kendinizi bir insan olarak tanıtın..."
              required
            />
          </div>
          <p className="mt-2 text-sm text-gray-500">
            İnsan Kanıtı, Proof of Humanity protokolü için gereklidir. Kendinizi kısaca tanıtın.
          </p>
        </div>
